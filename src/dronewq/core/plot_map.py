...
def plot_basemap(
    ...
    Parameters
        ...
        zoom (str): zoom level of the contextily basemap
    ...
    if isinstance(source, str):
        ...
        data, extent = cx.bounds2img(
            west, south, east, north, zoom=zoom, ll=True, source=source
        )
...
def plot_georeferenced_data(
    ...
    norm: None = None,
    zoom: str = "auto",
    basemap: Bunch | str = cx.providers.OpenStreetMap.Mapnik,
    ...
    Args:
        ...
        zoom (optional): Zoom level of the basemap.
