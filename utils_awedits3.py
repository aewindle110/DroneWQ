...
def write_exif_csv(img_set, outputPath):
    """
    This is the specific EXIF data we save as a .csv. More metadata could be added based on what is needed in your workflow.
    """
...
def std_glint_removal_method(lt_dir, glint_corrected_lt_dir, glint_std_factor=1):
    """
    the glint_std_factor filters NIR pixels > than mean+std*glint_std_factor. The lower it is, the more pixels will be masked. Same pixel indicies are masked across all bands. 
